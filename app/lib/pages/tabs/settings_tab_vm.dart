...
class SettingsTabVm with SettingsTabVmMappable {
  ...
  final TextEditingController relayServerUrlController;
  final TextEditingController relayRoomController;
  ...
  SettingsTabVm({
    ...
    required this.relayServerUrlController,
    required this.relayRoomController,
